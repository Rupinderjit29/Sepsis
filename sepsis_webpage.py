...
def main():
    ...
    st.title2("For the prediction of SIRS, Sepsis and Septic Shock, click on [Link](https://rupinderjit29-sepsis-prediction-sepsis-ghy2gk.streamlit.app/)")
    ...
    with st.sidebar:
        ...
        if st.button('Predict SIRS') :
            ...
            if ab==True:
                ...
                st.caption('_If further fields are not displayed, then press enter key._')
